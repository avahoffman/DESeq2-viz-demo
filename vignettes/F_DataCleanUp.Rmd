---
title: "F. Cleaning up Data on the AnVIL Workspace"
author:
...
The first vignette [An Overview of AnVILBulkRNASeq](A_Overview.ipynb) shows how
...
The vignette [Running the Workflow Within AnVIL](C_RunningTheWorkflow.ipynb)
...
```{r workspace}
avworkspace("hoffman-ava/DESeq2-visualization-demo")
